...
struct FHitResult
{
	...
	AWeakObjectPtr<AActor> GetActorField() const { return GetNativeField<AWeakObjectPtr<AActor>>(this, "FHitResult", "Actor"); }
...
struct RCONClientConnection
{
	...
	TArray<signed char, FDefaultAllocator> GetDataBufferField() const { return GetNativeField<TArray<signed char, FDefaultAllocator>>(this, "RCONClientConnection", "DataBuffer"); }
	void SetDataBufferField(TArray<signed char, FDefaultAllocator> newValue) { SetNativeField(this, "RCONClientConnection", "DataBuffer", newValue); }
...
struct UGameplayStatics
{
	...
	static void GetActorArrayBounds(TArray<AActor *, FDefaultAllocator>* Actors, bool bOnlyCollidingComponents, FVector* Center, FVector* BoxExtent) { NativeCall<void, TArray<AActor *, FDefaultAllocator> *, bool, FVector *, FVector *>(nullptr, "UGameplayStatics", "GetActorArrayBounds", Actors, bOnlyCollidingComponents, Center, BoxExtent); }
