...
{
	//TArray<FDamageTypeAdjuster, FDefaultAllocator> GetDamageTypeAdjustersField() const { return GetNativeField<TArray<FDamageTypeAdjuster, FDefaultAllocator>>(this, "APrimalTargetableActor", "DamageTypeAdjusters"); }
	...
	//TArray<FBoneDamageAdjuster, FDefaultAllocator> GetBoneDamageAdjustersField() const { return GetNativeField<TArray<FBoneDamageAdjuster, FDefaultAllocator>>(this, "APrimalTargetableActor", "BoneDamageAdjusters"); }
...
struct APrimalStructure : APrimalTargetableActor
{
	...
	//TArray<FPrimalStructureSnapPoint, FDefaultAllocator> GetSnapPointsField() const { return GetNativeField<TArray<FPrimalStructureSnapPoint, FDefaultAllocator>>(this, "APrimalStructure", "SnapPoints"); }
	//void SetSnapPointsField(TArray<FPrimalStructureSnapPoint, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalStructure", "SnapPoints", newValue); }
	...
	TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> GetPreventPlacingOnFloorClassesField() const { return GetNativeField<TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator>>(this, "APrimalStructure", "PreventPlacingOnFloorClasses"); }
	void SetPreventPlacingOnFloorClassesField(TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalStructure", "PreventPlacingOnFloorClasses", newValue); }
	TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> GetAllowPlacingOnFloorClassesField() const { return GetNativeField<TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator>>(this, "APrimalStructure", "AllowPlacingOnFloorClasses"); }
	void SetAllowPlacingOnFloorClassesField(TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalStructure", "AllowPlacingOnFloorClasses", newValue); }
	...
	TArray<TSubclassOf<UDamageType>, FDefaultAllocator> GetReturnDamageExcludeIncomingTypesField() const { return GetNativeField<TArray<TSubclassOf<UDamageType>, FDefaultAllocator>>(this, "APrimalStructure", "ReturnDamageExcludeIncomingTypes"); }
	void SetReturnDamageExcludeIncomingTypesField(TArray<TSubclassOf<UDamageType>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalStructure", "ReturnDamageExcludeIncomingTypes", newValue); }
	TArray<TSubclassOf<UDamageType>, FDefaultAllocator> GetReturnDamageOnlyForIncomingTypesField() const { return GetNativeField<TArray<TSubclassOf<UDamageType>, FDefaultAllocator>>(this, "APrimalStructure", "ReturnDamageOnlyForIncomingTypes"); }
	void SetReturnDamageOnlyForIncomingTypesField(TArray<TSubclassOf<UDamageType>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalStructure", "ReturnDamageOnlyForIncomingTypes", newValue); }
	...
	AWeakObjectPtr<APrimalDinoCharacter> GetSaddleDinoField() const { return GetNativeField<AWeakObjectPtr<APrimalDinoCharacter>>(this, "APrimalStructure", "SaddleDino"); }
	TArray<APrimalDinoCharacter *, FDefaultAllocator> GetLatchedDinosField() const { return GetNativeField<TArray<APrimalDinoCharacter *, FDefaultAllocator>>(this, "APrimalStructure", "LatchedDinos"); }
	...
	TArray<FVector, FDefaultAllocator> GetPlacementTraceDirectionsField() const { return GetNativeField<TArray<FVector, FDefaultAllocator>>(this, "APrimalStructure", "PlacementTraceDirections"); }
	void SetPlacementTraceDirectionsField(TArray<FVector, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalStructure", "PlacementTraceDirections", newValue); }
	TArray<APrimalStructure *, FDefaultAllocator> GetLinkedStructuresField() const { return GetNativeField<TArray<APrimalStructure *, FDefaultAllocator>>(this, "APrimalStructure", "LinkedStructures"); }
	TArray<unsigned int, FDefaultAllocator> GetLinkedStructuresIDField() const { return GetNativeField<TArray<unsigned int, FDefaultAllocator>>(this, "APrimalStructure", "LinkedStructuresID"); }
	TArray<APrimalStructure *, FDefaultAllocator> GetStructuresPlacedOnFloorField() const { return GetNativeField<TArray<APrimalStructure *, FDefaultAllocator>>(this, "APrimalStructure", "StructuresPlacedOnFloor"); }
	void SetStructuresPlacedOnFloorField(TArray<APrimalStructure *, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalStructure", "StructuresPlacedOnFloor", newValue); }
	TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> GetSnapToStructureTypesToExcludeField() const { return GetNativeField<TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator>>(this, "APrimalStructure", "SnapToStructureTypesToExclude"); }
	TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> GetSnapFromStructureTypesToExcludeField() const { return GetNativeField<TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator>>(this, "APrimalStructure", "SnapFromStructureTypesToExclude"); }
	void SetSnapFromStructureTypesToExcludeField(TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalStructure", "SnapFromStructureTypesToExclude", newValue); }
	...
	TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> GetOnlyAllowStructureClassesToAttachField() const { return GetNativeField<TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator>>(this, "APrimalStructure", "OnlyAllowStructureClassesToAttach"); }
	void SetOnlyAllowStructureClassesToAttachField(TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalStructure", "OnlyAllowStructureClassesToAttach", newValue); }
	TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> GetOnlyAllowStructureClassesFromAttachField() const { return GetNativeField<TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator>>(this, "APrimalStructure", "OnlyAllowStructureClassesFromAttach"); }
	void SetOnlyAllowStructureClassesFromAttachField(TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalStructure", "OnlyAllowStructureClassesFromAttach", newValue); }
	...
	TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> GetExcludeInStructuresRadiusClassesField() const { return GetNativeField<TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator>>(this, "APrimalStructure", "ExcludeInStructuresRadiusClasses"); }
	void SetExcludeInStructuresRadiusClassesField(TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalStructure", "ExcludeInStructuresRadiusClasses", newValue); }
	...
	TArray<FString, FDefaultAllocator> GetPreventBuildStructureReasonStringOverridesField() const { return GetNativeField<TArray<FString, FDefaultAllocator>>(this, "APrimalStructure", "PreventBuildStructureReasonStringOverrides"); }
	void SetPreventBuildStructureReasonStringOverridesField(TArray<FString, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalStructure", "PreventBuildStructureReasonStringOverrides", newValue); }
	...
	TArray<TSubclassOf<APrimalDinoCharacter>, FDefaultAllocator> GetPreventSaddleDinoClassesField() const { return GetNativeField<TArray<TSubclassOf<APrimalDinoCharacter>, FDefaultAllocator>>(this, "APrimalStructure", "PreventSaddleDinoClasses"); }
	void SetPreventSaddleDinoClassesField(TArray<TSubclassOf<APrimalDinoCharacter>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalStructure", "PreventSaddleDinoClasses", newValue); }
	TArray<TSubclassOf<APrimalDinoCharacter>, FDefaultAllocator> GetAllowSaddleDinoClassesField() const { return GetNativeField<TArray<TSubclassOf<APrimalDinoCharacter>, FDefaultAllocator>>(this, "APrimalStructure", "AllowSaddleDinoClasses"); }
	void SetAllowSaddleDinoClassesField(TArray<TSubclassOf<APrimalDinoCharacter>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalStructure", "AllowSaddleDinoClasses", newValue); }
	...
	//void FindFoundations(APrimalStructure * StartingStructure TArray<APrimalStructure *, FDefaultAllocator> * Foundations) { NativeCall<void, APrimalStructure *, TArray<APrimalStructure *, FDefaultAllocator> *>((DWORD64)this, "APrimalStructure", "FindFoundations", StartingStructure, Foundations); }
	//void CullAgainstFoundations(APrimalStructure ** StartingStructure TArray<APrimalStructure *, FDefaultAllocator> * Foundations) { NativeCall<void, APrimalStructure **, TArray<APrimalStructure *, FDefaultAllocator> *>((DWORD64)this, "APrimalStructure", "CullAgainstFoundations", StartingStructure, Foundations); }
	void FlagReachable(TArray<APrimalStructure *, FDefaultAllocator>* Foundations) { NativeCall<void, TArray<APrimalStructure *, FDefaultAllocator> *>((DWORD64)this, "APrimalStructure", "FlagReachable", Foundations); }
	...
	void GetAllLinkedStructures(TArray<APrimalStructure *, FDefaultAllocator>* OutLinkedStructures) { NativeCall<void, TArray<APrimalStructure *, FDefaultAllocator> *>((DWORD64)this, "APrimalStructure", "GetAllLinkedStructures", OutLinkedStructures); }
	...
	//void GetNearbyStructuresOfClass(UWorld * World TSubclassOf<APrimalStructure> StructureClass, FVector * Location, float Range, TArray<APrimalStructure *, FDefaultAllocator> * Structures) { NativeCall<void, UWorld *, TSubclassOf<APrimalStructure>, FVector *, float, TArray<APrimalStructure *, FDefaultAllocator> *>((DWORD64)this, "APrimalStructure", "GetNearbyStructuresOfClass", World, StructureClass, Location, Range, Structures); }
	void ClientUpdateLinkedStructures_Implementation(TArray<unsigned int, FDefaultAllocator>* NewLinkedStructures) { NativeCall<void, TArray<unsigned int, FDefaultAllocator> *>((DWORD64)this, "APrimalStructure", "ClientUpdateLinkedStructures_Implementation", NewLinkedStructures); }
	...
	void ClientUpdateLinkedStructures(TArray<unsigned int, FDefaultAllocator>* NewLinkedStructures) { NativeCall<void, TArray<unsigned int, FDefaultAllocator> *>((DWORD64)this, "APrimalStructure", "ClientUpdateLinkedStructures", NewLinkedStructures); }
