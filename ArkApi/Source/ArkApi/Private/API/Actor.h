...
public:
	...
	FBoxSphereBounds GetBoundsField() const { return GetNativeField<FBoxSphereBounds>(this, "USceneComponent", "Bounds"); }
	void SetBoundsField(FBoxSphereBounds newValue) { SetNativeField(this, "USceneComponent", "Bounds", newValue); }
	...
	TArray<USceneComponent *, FDefaultAllocator> GetAttachChildrenField() const { return GetNativeField<TArray<USceneComponent *, FDefaultAllocator>>(this, "USceneComponent", "AttachChildren"); }
	void SetAttachChildrenField(TArray<USceneComponent *, FDefaultAllocator> newValue) { SetNativeField(this, "USceneComponent", "AttachChildren", newValue); }
	...
	void UpdateComponentToWorldWithParent(USceneComponent* Parent, bool bSkipPhysicsMove, FQuat* RelativeRotationQuat) { NativeCall<void, USceneComponent *, bool, FQuat *>((DWORD64)this, "USceneComponent", "UpdateComponentToWorldWithParent", Parent, bSkipPhysicsMove, RelativeRotationQuat); }
	...
	FBoxSphereBounds* CalcBounds(FBoxSphereBounds* result, FTransform* LocalToWorld) { return NativeCall<FBoxSphereBounds *, FBoxSphereBounds *, FTransform *>((DWORD64)this, "USceneComponent", "CalcBounds", result, LocalToWorld); }
	...
	void SetWorldRotation(FQuat* NewRotation, bool bSweep) { NativeCall<void, FQuat *, bool>((DWORD64)this, "USceneComponent", "SetWorldRotation", NewRotation, bSweep); }
	...
	void GetParentComponents(TArray<USceneComponent *, FDefaultAllocator>* Parents) { NativeCall<void, TArray<USceneComponent *, FDefaultAllocator> *>((DWORD64)this, "USceneComponent", "GetParentComponents", Parents); }
	void GetChildrenComponents(bool bIncludeAllDescendants, TArray<USceneComponent *, FDefaultAllocator>* Children) { NativeCall<void, bool, TArray<USceneComponent *, FDefaultAllocator> *>((DWORD64)this, "USceneComponent", "GetChildrenComponents", bIncludeAllDescendants, Children); }
	void AppendDescendants(TArray<USceneComponent *, FDefaultAllocator>* Children) { NativeCall<void, TArray<USceneComponent *, FDefaultAllocator> *>((DWORD64)this, "USceneComponent", "AppendDescendants", Children); }
	...
	void Serialize(FArchive* Ar) { NativeCall<void, FArchive *>((DWORD64)this, "USceneComponent", "Serialize", Ar); }
	...
	FQuat* GetSocketQuaternion(FQuat* result, FName SocketName) { return NativeCall<FQuat *, FQuat *, FName>((DWORD64)this, "USceneComponent", "GetSocketQuaternion", result, SocketName); }
...
class AActor : public UObjectBaseUtility
{
public:
	...
	TArray<AActor *, FDefaultAllocator> GetNetworkSpatializationChildrenField() const { return GetNativeField<TArray<AActor *, FDefaultAllocator>>(this, "AActor", "NetworkSpatializationChildren"); }
	void SetNetworkSpatializationChildrenField(TArray<AActor *, FDefaultAllocator> newValue) { SetNativeField(this, "AActor", "NetworkSpatializationChildren", newValue); }
	...
	TArray<AActor *, FDefaultAllocator> GetChildrenField() const { return GetNativeField<TArray<AActor *, FDefaultAllocator>>(this, "AActor", "Children"); }
	void SetChildrenField(TArray<AActor *, FDefaultAllocator> newValue) { SetNativeField(this, "AActor", "Children", newValue); }
	...
	TArray<FName, FDefaultAllocator> GetLayersField() const { return GetNativeField<TArray<FName, FDefaultAllocator>>(this, "AActor", "Layers"); }
	void SetLayersField(TArray<FName, FDefaultAllocator> newValue) { SetNativeField(this, "AActor", "Layers", newValue); }
	...
	TArray<FName, FDefaultAllocator> GetTagsField() const { return GetNativeField<TArray<FName, FDefaultAllocator>>(this, "AActor", "Tags"); }
	void SetTagsField(TArray<FName, FDefaultAllocator> newValue) { SetNativeField(this, "AActor", "Tags", newValue); }
	...
	void GetOverlappingActors(TArray<AActor *, FDefaultAllocator>* OverlappingActors, UClass* ClassFilter) { NativeCall<void, TArray<AActor *, FDefaultAllocator> *, UClass *>((DWORD64)this, "AActor", "GetOverlappingActors", OverlappingActors, ClassFilter); }
	...
	void GetAttachedActors(TArray<AActor *, FDefaultAllocator>* OutActors) { NativeCall<void, TArray<AActor *, FDefaultAllocator> *>((DWORD64)this, "AActor", "GetAttachedActors", OutActors); }
	...
	void GetSubobjectsWithStableNamesForNetworking(TArray<UObject *, FDefaultAllocator>* ObjList) { NativeCall<void, TArray<UObject *, FDefaultAllocator> *>((DWORD64)this, "AActor", "GetSubobjectsWithStableNamesForNetworking", ObjList); }
...
struct AShooterPlayerState : APlayerState
{
	...
	TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator> GetEngramItemBlueprintsField() const { return GetNativeField<TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator>>(this, "AShooterPlayerState", "EngramItemBlueprints"); }
...
{
	AWeakObjectPtr<APawn> GetOldPawnField() const { return GetNativeField<AWeakObjectPtr<APawn>>(this, "AController", "OldPawn"); }
	...
	AWeakObjectPtr<AActor> GetStartSpotField() const { return GetNativeField<AWeakObjectPtr<AActor>>(this, "AController", "StartSpot"); }
...
public:
	...
	TArray<FName, FDefaultAllocator> GetPendingMapChangeLevelNamesField() const { return GetNativeField<TArray<FName, FDefaultAllocator>>(this, "APlayerController", "PendingMapChangeLevelNames"); }
	...
	//bool GetHitResultUnderCursorForObjects(TArray<TEnumAsByte<enum EObjectTypeQuery>, FDefaultAllocator> * ObjectTypes, bool bTraceComplex, FHitResult * HitResult) { return NativeCall<bool, TArray<TEnumAsByte<enum EObjectTypeQuery>, FDefaultAllocator> *, bool, FHitResult *>((DWORD64)this, "APlayerController", "GetHitResultUnderCursorForObjects", ObjectTypes, bTraceComplex, HitResult); }
	...
	//bool GetHitResultUnderFingerForObjects(ETouchIndex::Type FingerIndex, TArray<TEnumAsByte<enum EObjectTypeQuery>, FDefaultAllocator> * ObjectTypes, bool bTraceComplex, FHitResult * HitResult) { return NativeCall<bool, ETouchIndex::Type, TArray<TEnumAsByte<enum EObjectTypeQuery>, FDefaultAllocator> *, bool, FHitResult *>((DWORD64)this, "APlayerController", "GetHitResultUnderFingerForObjects", FingerIndex, ObjectTypes, bTraceComplex, HitResult); }
	...
	//bool GetHitResultAtScreenPosition(FVector2D ScreenPosition, TArray<TEnumAsByte<enum EObjectTypeQuery>, FDefaultAllocator> * ObjectTypes, bool bTraceComplex, FHitResult * HitResult) { return NativeCall<bool, FVector2D, TArray<TEnumAsByte<enum EObjectTypeQuery>, FDefaultAllocator> *, bool, FHitResult *>((DWORD64)this, "APlayerController", "GetHitResultAtScreenPosition", ScreenPosition, ObjectTypes, bTraceComplex, HitResult); }
	...
	EMouseCursor::Type GetMouseCursor() { return NativeCall<EMouseCursor::Type>((DWORD64)this, "APlayerController", "GetMouseCursor"); }
	...
	void GetSeamlessTravelActorList(bool bToEntry, TArray<AActor *, FDefaultAllocator>* ActorList) { NativeCall<void, bool, TArray<AActor *, FDefaultAllocator> *>((DWORD64)this, "APlayerController", "GetSeamlessTravelActorList", bToEntry, ActorList); }
...
struct AShooterPlayerController : public APlayerController
{
	...
	AWeakObjectPtr<APrimalCharacter> GetLastDeathPrimalCharacterField() const { return GetNativeField<AWeakObjectPtr<APrimalCharacter>>(this, "AShooterPlayerController", "LastDeathPrimalCharacter"); }
	...
	AWeakObjectPtr<UPrimalItem> GetSelectedSlotItemField() const { return GetNativeField<AWeakObjectPtr<UPrimalItem>>(this, "AShooterPlayerController", "SelectedSlotItem"); }
	//UPrimalLocalProfile * GetPrimalLocalProfileField() const { return GetNativeField<UPrimalLocalProfile *>(this, "AShooterPlayerController", "PrimalLocalProfile"); }
	...
	AWeakObjectPtr<AShooterCharacter> GetLastControlledPlayerCharacterField() const { return GetNativeField<AWeakObjectPtr<AShooterCharacter>>(this, "AShooterPlayerController", "LastControlledPlayerCharacter"); }
	//TSubclassOf<APrimalStructurePlacer> GetStructurePlacerClassField() const { return GetNativeField<TSubclassOf<APrimalStructurePlacer>>(this, "AShooterPlayerController", "StructurePlacerClass"); }
	...
	TArray<AWeakObjectPtr<UPrimalInventoryComponent>, FDefaultAllocator> GetRemoteViewingInventoriesField() const { return GetNativeField<TArray<AWeakObjectPtr<UPrimalInventoryComponent>, FDefaultAllocator>>(this, "AShooterPlayerController", "RemoteViewingInventories"); }
	AWeakObjectPtr<AActor> GetLastHeldUseActorField() const { return GetNativeField<AWeakObjectPtr<AActor>>(this, "AShooterPlayerController", "LastHeldUseActor"); }
	...
	//AWeakObjectPtr<APrimalStructureBed> GetSpawnAtBedField() const { return GetNativeField<AWeakObjectPtr<APrimalStructureBed>>(this, "AShooterPlayerController", "SpawnAtBed"); }
	//void SetSpawnAtBedField(AWeakObjectPtr<APrimalStructureBed> newValue) { SetNativeField(this, "AShooterPlayerController", "SpawnAtBed", newValue); }
	...
	//TMap<FGuid, FARKTributeData, FDefaultSetAllocator, TDefaultMapKeyFuncs<FGuid, FARKTributeData, 0> > GetLastArkTributeDataField() const { return GetNativeField<TMap<FGuid, FARKTributeData, FDefaultSetAllocator, TDefaultMapKeyFuncs<FGuid, FARKTributeData, 0> >>(this, "AShooterPlayerController", "LastArkTributeData"); }
	...
	TArray<int, FDefaultAllocator> GetPlayerAppIDsField() const { return GetNativeField<TArray<int, FDefaultAllocator>>(this, "AShooterPlayerController", "PlayerAppIDs"); }
	void SetPlayerAppIDsField(TArray<int, FDefaultAllocator> newValue) { SetNativeField(this, "AShooterPlayerController", "PlayerAppIDs", newValue); }
	TArray<int, FDefaultAllocator> GetNotifiedTribeWarIDsField() const { return GetNativeField<TArray<int, FDefaultAllocator>>(this, "AShooterPlayerController", "NotifiedTribeWarIDs"); }
	void SetNotifiedTribeWarIDsField(TArray<int, FDefaultAllocator> newValue) { SetNativeField(this, "AShooterPlayerController", "NotifiedTribeWarIDs", newValue); }
	TArray<FString, FDefaultAllocator> GetNotifiedTribeWarNamesField() const { return GetNativeField<TArray<FString, FDefaultAllocator>>(this, "AShooterPlayerController", "NotifiedTribeWarNames"); }
	void SetNotifiedTribeWarNamesField(TArray<FString, FDefaultAllocator> newValue) { SetNativeField(this, "AShooterPlayerController", "NotifiedTribeWarNames", newValue); }
	...
	TArray<FString, FDefaultAllocator> GetCurrentTribeLogField() const { return GetNativeField<TArray<FString, FDefaultAllocator>>(this, "AShooterPlayerController", "CurrentTribeLog"); }
	void SetCurrentTribeLogField(TArray<FString, FDefaultAllocator> newValue) { SetNativeField(this, "AShooterPlayerController", "CurrentTribeLog", newValue); }
	...
	//TArray<FSteamInventoryItemInfo, FDefaultAllocator> GetPlayerInventoryItemsField() const { return GetNativeField<TArray<FSteamInventoryItemInfo, FDefaultAllocator>>(this, "AShooterPlayerController", "PlayerInventoryItems"); }
	...
	TArray<FString, FDefaultAllocator>* GetCheatsCommands(TArray<FString, FDefaultAllocator>* result) { return NativeCall<TArray<FString, FDefaultAllocator> *, TArray<FString, FDefaultAllocator> *>((DWORD64)this, "AShooterPlayerController", "GetCheatsCommands", result); }
	...
	//bool GetAllAimedHarvestActors(float MaxDistance, TArray<AActor *, FDefaultAllocator>* OutHarvestActors, TArray<UActorComponent *, FDefaultAllocator>* OutHarvestComponents, TArray<int, FDefaultAllocator>* OutHitBodyIndices) { return NativeCall<bool, float, TArray<AActor *, FDefaultAllocator> *, TArray<UActorComponent *, FDefaultAllocator> *, TArray<int, FDefaultAllocator> *>((DWORD64)this, "AShooterPlayerController", "GetAllAimedHarvestActors", MaxDistance, OutHarvestActors, OutHarvestComponents, OutHitBodyIndices); }
	...
	void ClientLoadArkItems_Implementation(UPrimalInventoryComponent* forInventory, TArray<FItemNetInfo, FDefaultAllocator>* itemInfos) { NativeCall<void, UPrimalInventoryComponent *, TArray<FItemNetInfo, FDefaultAllocator> *>((DWORD64)this, "AShooterPlayerController", "ClientLoadArkItems_Implementation", forInventory, itemInfos); }
	...
	void ServerRequestCreateNewPlayerWithArkData(TArray<unsigned char, FDefaultAllocator>* PlayerArkDataBytes, unsigned __int64 TribeID) { NativeCall<void, TArray<unsigned char, FDefaultAllocator> *, unsigned __int64>((DWORD64)this, "AShooterPlayerController", "ServerRequestCreateNewPlayerWithArkData", PlayerArkDataBytes, TribeID); }
	...
	void ServerRequestSetPin_Implementation(UObject* forTarget, int PinValue, bool bIsSetting) { NativeCall<void, UObject *, int, bool>((DWORD64)this, "AShooterPlayerController", "ServerRequestSetPin_Implementation", forTarget, PinValue, bIsSetting); }
	...
	void ServerDownloadDino() { NativeCall<void>((DWORD64)this, "AShooterPlayerController", "ServerDownloadDino"); }
	...
	void ClientOnAddedItemsToAllClustersInventory_Implementation(bool Success, FString* UserId, TArray<int, FDefaultAllocator>* MasterIndexNum) { NativeCall<void, bool, FString *, TArray<int, FDefaultAllocator> *>((DWORD64)this, "AShooterPlayerController", "ClientOnAddedItemsToAllClustersInventory_Implementation", Success, UserId, MasterIndexNum); }
	void OnAddedItemsToAllClustersInventory(bool Success, FString* UserId, TArray<int, FDefaultAllocator>* MasterIndexNum) { NativeCall<void, bool, FString *, TArray<int, FDefaultAllocator> *>((DWORD64)this, "AShooterPlayerController", "OnAddedItemsToAllClustersInventory", Success, UserId, MasterIndexNum); }
	...
	void ClientServerSOTFNotificationCustom_Implementation() { NativeCall<void>((DWORD64)this, "AShooterPlayerController", "ClientServerSOTFNotificationCustom_Implementation"); }
	...
	TArray<unsigned int, FDefaultAllocator>* GetRadioFrequencies(TArray<unsigned int, FDefaultAllocator>* result) { return NativeCall<TArray<unsigned int, FDefaultAllocator> *, TArray<unsigned int, FDefaultAllocator> *>((DWORD64)this, "AShooterPlayerController", "GetRadioFrequencies", result); }
	...
	void OnArkTributeAllClustersInventoryItemsLoaded(TArray<FItemNetInfo, FDefaultAllocator>* Items) { NativeCall<void, TArray<FItemNetInfo, FDefaultAllocator> *>((DWORD64)this, "AShooterPlayerController", "OnArkTributeAllClustersInventoryItemsLoaded", Items); }
	void OnArkTributeSaved(bool Success) { NativeCall<void, bool>((DWORD64)this, "AShooterPlayerController", "OnArkTributeSaved", Success); }
	void ClientSetArkTributeLimits_Implementation(bool LimitItems, bool LimitDinos, bool LimitCharacters) { NativeCall<void, bool, bool, bool>((DWORD64)this, "AShooterPlayerController", "ClientSetArkTributeLimits_Implementation", LimitItems, LimitDinos, LimitCharacters); }
	void ServerLoadArkInventoryItems_Implementation(TArray<FItemNetInfo, FDefaultAllocator>* ArkInventoryItemsInfo) { NativeCall<void, TArray<FItemNetInfo, FDefaultAllocator> *>((DWORD64)this, "AShooterPlayerController", "ServerLoadArkInventoryItems_Implementation", ArkInventoryItemsInfo); }
	void GetTamedDinosNearBy(TArray<AWeakObjectPtr<APrimalDinoCharacter>, FDefaultAllocator>* Dinos, float RangeRadius) { NativeCall<void, TArray<AWeakObjectPtr<APrimalDinoCharacter>, FDefaultAllocator> *, float>((DWORD64)this, "AShooterPlayerController", "GetTamedDinosNearBy", Dinos, RangeRadius); }
	...
	void ServerSetSubscribedApps_Implementation(TArray<int, FDefaultAllocator>* AppIDs) { NativeCall<void, TArray<int, FDefaultAllocator> *>((DWORD64)this, "AShooterPlayerController", "ServerSetSubscribedApps_Implementation", AppIDs); }
	...
	void ClientRemoveItemFromSteamInventory_Implementation(TArray<unsigned __int64, FDefaultAllocator>* ItemSteamUserID, int Quantity) { NativeCall<void, TArray<unsigned __int64, FDefaultAllocator> *, int>((DWORD64)this, "AShooterPlayerController", "ClientRemoveItemFromSteamInventory_Implementation", ItemSteamUserID, Quantity); }
	...
	void ClientOnAddedItemsToAllClustersInventory(bool Success, FString* UserId, TArray<int, FDefaultAllocator>* MasterIndexNum) { NativeCall<void, bool, FString *, TArray<int, FDefaultAllocator> *>((DWORD64)this, "AShooterPlayerController", "ClientOnAddedItemsToAllClustersInventory", Success, UserId, MasterIndexNum); }
	...
	//void ClientReceiveDinoAncestors(APrimalDinoCharacter* ForDino, TArray<FDinoAncestorsEntry, FDefaultAllocator>* DinoAncestors, TArray<FDinoAncestorsEntry, FDefaultAllocator>* DinoAncestorsMale, int RandomMutationsFemale, int RandomMutationsMale) { NativeCall<void, APrimalDinoCharacter *, TArray<FDinoAncestorsEntry, FDefaultAllocator> *, TArray<FDinoAncestorsEntry, FDefaultAllocator> *, int, int>((DWORD64)this, "AShooterPlayerController", "ClientReceiveDinoAncestors", ForDino, DinoAncestors, DinoAncestorsMale, RandomMutationsFemale, RandomMutationsMale); }
	...
	void ClientRemoveItemFromSteamInventory(TArray<unsigned __int64, FDefaultAllocator>* ItemSteamUserID, int Quantity) { NativeCall<void, TArray<unsigned __int64, FDefaultAllocator> *, int>((DWORD64)this, "AShooterPlayerController", "ClientRemoveItemFromSteamInventory", ItemSteamUserID, Quantity); }
	void ClientSendArkDataPayloadBegin() { NativeCall<void>((DWORD64)this, "AShooterPlayerController", "ClientSendArkDataPayloadBegin"); }
	void ClientServerChatDirectMessage() { NativeCall<void>((DWORD64)this, "AShooterPlayerController", "ClientServerChatDirectMessage"); }
	void ClientServerNotification() { NativeCall<void>((DWORD64)this, "AShooterPlayerController", "ClientServerNotification"); }
	void ClientServerSOTFNotificationCustom() { NativeCall<void>((DWORD64)this, "AShooterPlayerController", "ClientServerSOTFNotificationCustom"); }
	...
	//void ClientUpdateInventoryCraftQueue(UPrimalInventoryComponent* forInventory, TArray<FItemCraftQueueEntry, FDefaultAllocator>* CraftQueueEntries) { NativeCall<void, UPrimalInventoryComponent *, TArray<FItemCraftQueueEntry, FDefaultAllocator> *>((DWORD64)this, "AShooterPlayerController", "ClientUpdateInventoryCraftQueue", forInventory, CraftQueueEntries); }
	...
	void ServerActorViewRemoteInventory(UPrimalInventoryComponent* inventoryComp) { NativeCall<void, UPrimalInventoryComponent *>((DWORD64)this, "AShooterPlayerController", "ServerActorViewRemoteInventory", inventoryComp); }
	...
	void ServerInventoryClearCraftQueue(UPrimalInventoryComponent* inventoryComp) { NativeCall<void, UPrimalInventoryComponent *>((DWORD64)this, "AShooterPlayerController", "ServerInventoryClearCraftQueue", inventoryComp); }
	...
	//void ServerPaint(UStructurePaintingComponent* Structure, TArray<FPaintItem, FDefaultAllocator>* Paints, bool bLastBatch, bool bFromLoadFile) { NativeCall<void, UStructurePaintingComponent *, TArray<FPaintItem, FDefaultAllocator> *, bool, bool>((DWORD64)this, "AShooterPlayerController", "ServerPaint", Structure, Paints, bLastBatch, bFromLoadFile); }
	...
	//void ServerRequestLevelUp(UPrimalCharacterStatusComponent* forStatusComp, EPrimalCharacterStatusValue::Type ValueType) { NativeCall<void, UPrimalCharacterStatusComponent *, EPrimalCharacterStatusValue::Type>((DWORD64)this, "AShooterPlayerController", "ServerRequestLevelUp", forStatusComp, ValueType); }
	void ServerSendArkDataPayloadBegin() { NativeCall<void>((DWORD64)this, "AShooterPlayerController", "ServerSendArkDataPayloadBegin"); }
	void ServerSendChatMessage(FString* ChatMessage, int SendMode) { NativeCall<void, FString *, int>((DWORD64)this, "AShooterPlayerController", "ServerSendChatMessage", ChatMessage, SendMode); }
...
struct APrimalCharacter : public ACharacter
{
	...
	//TArray<APrimalBuff *, FDefaultAllocator> GetBuffsField() const { return GetNativeField<TArray<APrimalBuff *, FDefaultAllocator>>(this, "APrimalCharacter", "Buffs"); }
	//void SetBuffsField(TArray<APrimalBuff *, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalCharacter", "Buffs", newValue); }
	...
	TArray<FName, FDefaultAllocator> GetBonesToIngoreWhileDraggedField() const { return GetNativeField<TArray<FName, FDefaultAllocator>>(this, "APrimalCharacter", "BonesToIngoreWhileDragged"); }
	void SetBonesToIngoreWhileDraggedField(TArray<FName, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalCharacter", "BonesToIngoreWhileDragged", newValue); }
	...
	TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> GetImmobilizationTrapsToIgnoreField() const { return GetNativeField<TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator>>(this, "APrimalCharacter", "ImmobilizationTrapsToIgnore"); }
	void SetImmobilizationTrapsToIgnoreField(TArray<TSubclassOf<APrimalStructure>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalCharacter", "ImmobilizationTrapsToIgnore", newValue); }
	//AWeakObjectPtr<APrimalStructureElevatorPlatform> GetBasedElevatorField() const { return GetNativeField<AWeakObjectPtr<APrimalStructureElevatorPlatform>>(this, "APrimalCharacter", "BasedElevator"); }
	AWeakObjectPtr<APrimalDinoCharacter> GetCarryingDinoField() const { return GetNativeField<AWeakObjectPtr<APrimalDinoCharacter>>(this, "APrimalCharacter", "CarryingDino"); }
	...
	AWeakObjectPtr<APrimalDinoCharacter> GetMountedDinoField() const { return GetNativeField<AWeakObjectPtr<APrimalDinoCharacter>>(this, "APrimalCharacter", "MountedDino"); }
	float GetMountedDinoTimeField() const { return GetNativeField<float>(this, "APrimalCharacter", "MountedDinoTime"); }
	AWeakObjectPtr<APrimalDinoCharacter> GetPreviousMountedDinoField() const { return GetNativeField<AWeakObjectPtr<APrimalDinoCharacter>>(this, "APrimalCharacter", "PreviousMountedDino"); }
	...
	TArray<int, FDefaultAllocator> GetReplicatedBonesIndiciesField() const { return GetNativeField<TArray<int, FDefaultAllocator>>(this, "APrimalCharacter", "ReplicatedBonesIndicies"); }
	void SetReplicatedBonesIndiciesField(TArray<int, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalCharacter", "ReplicatedBonesIndicies", newValue); }
	...
	TArray<FName, FDefaultAllocator> GetReplicatedBonesField() const { return GetNativeField<TArray<FName, FDefaultAllocator>>(this, "APrimalCharacter", "ReplicatedBones"); }
	void SetReplicatedBonesField(TArray<FName, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalCharacter", "ReplicatedBones", newValue); }
	...
	AWeakObjectPtr<APrimalCharacter> GetLastHurtByNearbyPlayerField() const { return GetNativeField<AWeakObjectPtr<APrimalCharacter>>(this, "APrimalCharacter", "LastHurtByNearbyPlayer"); }
	...
	AWeakObjectPtr<APrimalCharacter> GetLastAttackedNearbyPlayerField() const { return GetNativeField<AWeakObjectPtr<APrimalCharacter>>(this, "APrimalCharacter", "LastAttackedNearbyPlayer"); }
	...
	//TArray<TSubclassOf<APrimalBuff>, FDefaultAllocator> GetDefaultBuffsField() const { return GetNativeField<TArray<TSubclassOf<APrimalBuff>, FDefaultAllocator>>(this, "APrimalCharacter", "DefaultBuffs"); }
	...
	TArray<AWeakObjectPtr<APrimalCharacter>, FDefaultAllocator> GetCharactersGrappledToMeField() const { return GetNativeField<TArray<AWeakObjectPtr<APrimalCharacter>, FDefaultAllocator>>(this, "APrimalCharacter", "CharactersGrappledToMe"); }
	...
	void Serialize(FArchive* Ar) { NativeCall<void, FArchive *>((DWORD64)this, "APrimalCharacter", "Serialize", Ar); }
...
{
	//TArray<FTransponderInfo, FDefaultAllocator> GetClientTranspondersInfoField() const { return GetNativeField<TArray<FTransponderInfo, FDefaultAllocator>>(this, "AShooterCharacter", "ClientTranspondersInfo"); }
	...
	//AWeakObjectPtr<APrimalStructureLadder> GetClimbingLadderField() const { return GetNativeField<AWeakObjectPtr<APrimalStructureLadder>>(this, "AShooterCharacter", "ClimbingLadder"); }
	...
	AWeakObjectPtr<APrimalDinoCharacter> GetRidingDinoField() const { return GetNativeField<AWeakObjectPtr<APrimalDinoCharacter>>(this, "AShooterCharacter", "RidingDino"); }
	TArray<FName, FDefaultAllocator> GetLowerBodyPartRootBonesField() const { return GetNativeField<TArray<FName, FDefaultAllocator>>(this, "AShooterCharacter", "LowerBodyPartRootBones"); }
	void SetLowerBodyPartRootBonesField(TArray<FName, FDefaultAllocator> newValue) { SetNativeField(this, "AShooterCharacter", "LowerBodyPartRootBones", newValue); }
	...
	//TArray<FItemAttachmentInfo, FDefaultAllocator> GetDefaultAttachmentInfosField() const { return GetNativeField<TArray<FItemAttachmentInfo, FDefaultAllocator>>(this, "AShooterCharacter", "DefaultAttachmentInfos"); }
	...
	AWeakObjectPtr<AController> GetLastControllerField() const { return GetNativeField<AWeakObjectPtr<AController>>(this, "AShooterCharacter", "LastController"); }
	...
	AWeakObjectPtr<AShooterCharacter> GetLastRequestedTribePlayerCharacterField() const { return GetNativeField<AWeakObjectPtr<AShooterCharacter>>(this, "AShooterCharacter", "LastRequestedTribePlayerCharacter"); }
	...
	//TArray<FOverrideAnimBlueprintEntry, FDefaultAllocator> GetOverrideAnimBlueprintsField() const { return GetNativeField<TArray<FOverrideAnimBlueprintEntry, FDefaultAllocator>>(this, "AShooterCharacter", "OverrideAnimBlueprints"); }
	...
	//AWeakObjectPtr<APrimalStructureSeating> GetSeatingStructureField() const { return GetNativeField<AWeakObjectPtr<APrimalStructureSeating>>(this, "AShooterCharacter", "SeatingStructure"); }
	...
	void Serialize(FArchive* Ar) { NativeCall<void, FArchive *>((DWORD64)this, "AShooterCharacter", "Serialize", Ar); }
...
struct FPrimalPersistentCharacterStatsStruct
{
	...
	TArray<unsigned int, FDefaultAllocator> GetPerMapExplorerNoteUnlocksField() const { return GetNativeField<TArray<unsigned int, FDefaultAllocator>>(this, "FPrimalPersistentCharacterStatsStruct", "PerMapExplorerNoteUnlocks"); }
	void SetPerMapExplorerNoteUnlocksField(TArray<unsigned int, FDefaultAllocator> newValue) { SetNativeField(this, "FPrimalPersistentCharacterStatsStruct", "PerMapExplorerNoteUnlocks", newValue); }
	TArray<FName, FDefaultAllocator> GetEmoteUnlocksField() const { return GetNativeField<TArray<FName, FDefaultAllocator>>(this, "FPrimalPersistentCharacterStatsStruct", "EmoteUnlocks"); }
	void SetEmoteUnlocksField(TArray<FName, FDefaultAllocator> newValue) { SetNativeField(this, "FPrimalPersistentCharacterStatsStruct", "EmoteUnlocks", newValue); }
	TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator> GetPlayerState_EngramBlueprintsField() const { return GetNativeField<TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator>>(this, "FPrimalPersistentCharacterStatsStruct", "PlayerState_EngramBlueprints"); }
	void SetPlayerState_EngramBlueprintsField(TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator> newValue) { SetNativeField(this, "FPrimalPersistentCharacterStatsStruct", "PlayerState_EngramBlueprints", newValue); }
...
struct UPrimalPlayerData
{
	...
	//TArray<UPrimalBuffPersistentData *, FDefaultAllocator> GetMyPersistentBuffDatasField() const { return GetNativeField<TArray<UPrimalBuffPersistentData *, FDefaultAllocator>>(this, "UPrimalPlayerData", "MyPersistentBuffDatas"); }
...
struct UPrimalCharacterStatusComponent
{
	...
	//TArray<FPrimalCharacterStatusValueModifier, FDefaultAllocator> GetStatusValueModifiersField() const { return GetNativeField<TArray<FPrimalCharacterStatusValueModifier, FDefaultAllocator>>(this, "UPrimalCharacterStatusComponent", "StatusValueModifiers"); }
	//void SetStatusValueModifiersField(TArray<FPrimalCharacterStatusValueModifier, FDefaultAllocator> newValue) { SetNativeField(this, "UPrimalCharacterStatusComponent", "StatusValueModifiers", newValue); }
	TArray<unsigned char, FDefaultAllocator> GetStatusValueModifierDescriptionIndicesField() const { return GetNativeField<TArray<unsigned char, FDefaultAllocator>>(this, "UPrimalCharacterStatusComponent", "StatusValueModifierDescriptionIndices"); }
	void SetStatusValueModifierDescriptionIndicesField(TArray<unsigned char, FDefaultAllocator> newValue) { SetNativeField(this, "UPrimalCharacterStatusComponent", "StatusValueModifierDescriptionIndices", newValue); }
	...
	//FString * GetStatusValueString(FString * result, EPrimalCharacterStatusValue::Type ValueType) { return NativeCall<FString *, FString *, EPrimalCharacterStatusValue::Type>((DWORD64)this, "UPrimalCharacterStatusComponent", "GetStatusValueString", result, ValueType); }
	void AddExperience(float HowMuch, bool bShareWithTribe, EXPType XPType) { NativeCall<void, float, bool, EXPType>((DWORD64)this, "UPrimalCharacterStatusComponent", "AddExperience", HowMuch, bShareWithTribe, XPType); }
	...
	void NetSyncMaxStatusValues_Implementation(TArray<float, FDefaultAllocator>* NetMaxStatusValues, TArray<float, FDefaultAllocator>* NetBaseMaxStatusValues) { NativeCall<void, TArray<float, FDefaultAllocator> *, TArray<float, FDefaultAllocator> *>((DWORD64)this, "UPrimalCharacterStatusComponent", "NetSyncMaxStatusValues_Implementation", NetMaxStatusValues, NetBaseMaxStatusValues); }
	void ClientSyncMaxStatusValues_Implementation(TArray<float, FDefaultAllocator>* NetMaxStatusValues, TArray<float, FDefaultAllocator>* NetBaseMaxStatusValues) { NativeCall<void, TArray<float, FDefaultAllocator> *, TArray<float, FDefaultAllocator> *>((DWORD64)this, "UPrimalCharacterStatusComponent", "ClientSyncMaxStatusValues_Implementation", NetMaxStatusValues, NetBaseMaxStatusValues); }
	void Serialize(FArchive* Ar) { NativeCall<void, FArchive *>((DWORD64)this, "UPrimalCharacterStatusComponent", "Serialize", Ar); }
...
{
	AWeakObjectPtr<AActor> GetForcedMasterTargetField() const { return GetNativeField<AWeakObjectPtr<AActor>>(this, "APrimalDinoCharacter", "ForcedMasterTarget"); }
	void SetForcedMasterTargetField(AWeakObjectPtr<AActor> newValue) { SetNativeField(this, "APrimalDinoCharacter", "ForcedMasterTarget", newValue); }
	...
	AWeakObjectPtr<APrimalCharacter> GetMountCharacterField() const { return GetNativeField<AWeakObjectPtr<APrimalCharacter>>(this, "APrimalDinoCharacter", "MountCharacter"); }
	void SetMountCharacterField(AWeakObjectPtr<APrimalCharacter> newValue) { SetNativeField(this, "APrimalDinoCharacter", "MountCharacter", newValue); }
	...
	TArray<FName, FDefaultAllocator> GetMeleeSwingSocketsField() const { return GetNativeField<TArray<FName, FDefaultAllocator>>(this, "APrimalDinoCharacter", "MeleeSwingSockets"); }
	void SetMeleeSwingSocketsField(TArray<FName, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "MeleeSwingSockets", newValue); }
	...
	//TArray<FDinoAttackInfo, FDefaultAllocator> GetAttackInfosField() const { return GetNativeField<TArray<FDinoAttackInfo, FDefaultAllocator>>(this, "APrimalDinoCharacter", "AttackInfos"); }
	...
	AWeakObjectPtr<AShooterCharacter> GetRiderField() const { return GetNativeField<AWeakObjectPtr<AShooterCharacter>>(this, "APrimalDinoCharacter", "Rider"); }
	void SetRiderField(AWeakObjectPtr<AShooterCharacter> newValue) { SetNativeField(this, "APrimalDinoCharacter", "Rider", newValue); }
	AWeakObjectPtr<AShooterCharacter> GetPreviousRiderField() const { return GetNativeField<AWeakObjectPtr<AShooterCharacter>>(this, "APrimalDinoCharacter", "PreviousRider"); }
	void SetPreviousRiderField(AWeakObjectPtr<AShooterCharacter> newValue) { SetNativeField(this, "APrimalDinoCharacter", "PreviousRider", newValue); }
	...
	//TArray<FSaddlePassengerSeatDefinition, FDefaultAllocator> GetNoSaddlePassengerSeatsField() const { return GetNativeField<TArray<FSaddlePassengerSeatDefinition, FDefaultAllocator>>(this, "APrimalDinoCharacter", "NoSaddlePassengerSeats"); }
	AWeakObjectPtr<APrimalCharacter> GetCarriedCharacterField() const { return GetNativeField<AWeakObjectPtr<APrimalCharacter>>(this, "APrimalDinoCharacter", "CarriedCharacter"); }
	void SetCarriedCharacterField(AWeakObjectPtr<APrimalCharacter> newValue) { SetNativeField(this, "APrimalDinoCharacter", "CarriedCharacter", newValue); }
	AWeakObjectPtr<APrimalCharacter> GetPreviousCarriedCharacterField() const { return GetNativeField<AWeakObjectPtr<APrimalCharacter>>(this, "APrimalDinoCharacter", "PreviousCarriedCharacter"); }
	void SetPreviousCarriedCharacterField(AWeakObjectPtr<APrimalCharacter> newValue) { SetNativeField(this, "APrimalDinoCharacter", "PreviousCarriedCharacter", newValue); }
	TArray<AWeakObjectPtr<AShooterCharacter>, FDefaultAllocator> GetPassengerPerSeatField() const { return GetNativeField<TArray<AWeakObjectPtr<AShooterCharacter>, FDefaultAllocator>>(this, "APrimalDinoCharacter", "PassengerPerSeat"); }
	void SetPassengerPerSeatField(TArray<AWeakObjectPtr<AShooterCharacter>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "PassengerPerSeat", newValue); }
	TArray<AWeakObjectPtr<AShooterCharacter>, FDefaultAllocator> GetPrevPassengerPerSeatField() const { return GetNativeField<TArray<AWeakObjectPtr<AShooterCharacter>, FDefaultAllocator>>(this, "APrimalDinoCharacter", "PrevPassengerPerSeat"); }
	void SetPrevPassengerPerSeatField(TArray<AWeakObjectPtr<AShooterCharacter>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "PrevPassengerPerSeat", newValue); }
	...
	//AWeakObjectPtr<UPrimalAIState> GetActiveStateField() const { return GetNativeField<AWeakObjectPtr<UPrimalAIState>>(this, "APrimalDinoCharacter", "ActiveState"); }
	//AWeakObjectPtr<UPrimalAIState> GetActiveWonderStateField() const { return GetNativeField<AWeakObjectPtr<UPrimalAIState>>(this, "APrimalDinoCharacter", "ActiveWonderState"); }
	...
	TArray<FVector, FDefaultAllocator> GetLastSocketPositionsField() const { return GetNativeField<TArray<FVector, FDefaultAllocator>>(this, "APrimalDinoCharacter", "LastSocketPositions"); }
	void SetLastSocketPositionsField(TArray<FVector, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "LastSocketPositions", newValue); }
	TArray<AWeakObjectPtr<AActor>, FDefaultAllocator> GetMeleeSwingHurtListField() const { return GetNativeField<TArray<AWeakObjectPtr<AActor>, FDefaultAllocator>>(this, "APrimalDinoCharacter", "MeleeSwingHurtList"); }
	void SetMeleeSwingHurtListField(TArray<AWeakObjectPtr<AActor>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "MeleeSwingHurtList", newValue); }
	...
	TArray<FName, FDefaultAllocator> GetHideBoneNamesField() const { return GetNativeField<TArray<FName, FDefaultAllocator>>(this, "APrimalDinoCharacter", "HideBoneNames"); }
	void SetHideBoneNamesField(TArray<FName, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "HideBoneNames", newValue); }
	...
	AWeakObjectPtr<AActor> GetTargetField() const { return GetNativeField<AWeakObjectPtr<AActor>>(this, "APrimalDinoCharacter", "Target"); }
	void SetTargetField(AWeakObjectPtr<AActor> newValue) { SetNativeField(this, "APrimalDinoCharacter", "Target", newValue); }
	AWeakObjectPtr<AActor> GetTamedFollowTargetField() const { return GetNativeField<AWeakObjectPtr<AActor>>(this, "APrimalDinoCharacter", "TamedFollowTarget"); }
	void SetTamedFollowTargetField(AWeakObjectPtr<AActor> newValue) { SetNativeField(this, "APrimalDinoCharacter", "TamedFollowTarget", newValue); }
	...
	TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator> GetDeathGiveItemClassesField() const { return GetNativeField<TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator>>(this, "APrimalDinoCharacter", "DeathGiveItemClasses"); }
	void SetDeathGiveItemClassesField(TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "DeathGiveItemClasses", newValue); }
	TArray<float, FDefaultAllocator> GetDeathGiveItemChanceToBeBlueprintField() const { return GetNativeField<TArray<float, FDefaultAllocator>>(this, "APrimalDinoCharacter", "DeathGiveItemChanceToBeBlueprint"); }
	void SetDeathGiveItemChanceToBeBlueprintField(TArray<float, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "DeathGiveItemChanceToBeBlueprint", newValue); }
	...
	//TArray<FPrimalSaddleStructure, FDefaultAllocator> GetSaddleStructuresField() const { return GetNativeField<TArray<FPrimalSaddleStructure, FDefaultAllocator>>(this, "APrimalDinoCharacter", "SaddleStructures"); }
	...
	TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator> GetEggItemsToSpawnField() const { return GetNativeField<TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator>>(this, "APrimalDinoCharacter", "EggItemsToSpawn"); }
	void SetEggItemsToSpawnField(TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "EggItemsToSpawn", newValue); }
	TArray<float, FDefaultAllocator> GetEggWeightsToSpawnField() const { return GetNativeField<TArray<float, FDefaultAllocator>>(this, "APrimalDinoCharacter", "EggWeightsToSpawn"); }
	void SetEggWeightsToSpawnField(TArray<float, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "EggWeightsToSpawn", newValue); }
	TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator> GetFertilizedEggItemsToSpawnField() const { return GetNativeField<TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator>>(this, "APrimalDinoCharacter", "FertilizedEggItemsToSpawn"); }
	void SetFertilizedEggItemsToSpawnField(TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "FertilizedEggItemsToSpawn", newValue); }
	TArray<float, FDefaultAllocator> GetFertilizedEggWeightsToSpawnField() const { return GetNativeField<TArray<float, FDefaultAllocator>>(this, "APrimalDinoCharacter", "FertilizedEggWeightsToSpawn"); }
	void SetFertilizedEggWeightsToSpawnField(TArray<float, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "FertilizedEggWeightsToSpawn", newValue); }
	...
	TArray<APrimalStructure *, FDefaultAllocator> GetLatchedOnStructuresField() const { return GetNativeField<TArray<APrimalStructure *, FDefaultAllocator>>(this, "APrimalDinoCharacter", "LatchedOnStructures"); }
	void SetLatchedOnStructuresField(TArray<APrimalStructure *, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "LatchedOnStructures", newValue); }
	...
	TArray<FName, FDefaultAllocator> GetStepDamageFootDamageSocketsField() const { return GetNativeField<TArray<FName, FDefaultAllocator>>(this, "APrimalDinoCharacter", "StepDamageFootDamageSockets"); }
	void SetStepDamageFootDamageSocketsField(TArray<FName, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "StepDamageFootDamageSockets", newValue); }
	...
	AWeakObjectPtr<APrimalCharacter> GetAutoDragByPawnField() const { return GetNativeField<AWeakObjectPtr<APrimalCharacter>>(this, "APrimalDinoCharacter", "AutoDragByPawn"); }
	...
	TArray<APrimalCharacter *, FDefaultAllocator> GetDraggedRagdollsField() const { return GetNativeField<TArray<APrimalCharacter *, FDefaultAllocator>>(this, "APrimalDinoCharacter", "DraggedRagdolls"); }
	void SetDraggedRagdollsField(TArray<APrimalCharacter *, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "DraggedRagdolls", newValue); }
	...
	TArray<APrimalStructure *, FDefaultAllocator> GetSaddledStructuresField() const { return GetNativeField<TArray<APrimalStructure *, FDefaultAllocator>>(this, "APrimalDinoCharacter", "SaddledStructures"); }
	void SetSaddledStructuresField(TArray<APrimalStructure *, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "SaddledStructures", newValue); }
	...
	//TArray<TSubclassOf<APrimalBuff>, FDefaultAllocator> GetDefaultTamedBuffsField() const { return GetNativeField<TArray<TSubclassOf<APrimalBuff>, FDefaultAllocator>>(this, "APrimalDinoCharacter", "DefaultTamedBuffs"); }
	...
	TArray<FName, FDefaultAllocator> GetFPVRiderBoneNamesToHideField() const { return GetNativeField<TArray<FName, FDefaultAllocator>>(this, "APrimalDinoCharacter", "FPVRiderBoneNamesToHide"); }
	void SetFPVRiderBoneNamesToHideField(TArray<FName, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "FPVRiderBoneNamesToHide", newValue); }
	...
	AWeakObjectPtr<AActor> GetRiderAttackTargetField() const { return GetNativeField<AWeakObjectPtr<AActor>>(this, "APrimalDinoCharacter", "RiderAttackTarget"); }
	void SetRiderAttackTargetField(AWeakObjectPtr<AActor> newValue) { SetNativeField(this, "APrimalDinoCharacter", "RiderAttackTarget", newValue); }
	...
	TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator> GetMyBabyCuddleFoodTypesField() const { return GetNativeField<TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator>>(this, "APrimalDinoCharacter", "MyBabyCuddleFoodTypes"); }
	void SetMyBabyCuddleFoodTypesField(TArray<TSubclassOf<UPrimalItem>, FDefaultAllocator> newValue) { SetNativeField(this, "APrimalDinoCharacter", "MyBabyCuddleFoodTypes", newValue); }
	...
	//TArray<FDinoAncestorsEntry, FDefaultAllocator> GetDinoAncestorsField() const { return GetNativeField<TArray<FDinoAncestorsEntry, FDefaultAllocator>>(this, "APrimalDinoCharacter", "DinoAncestors"); }
	//TArray<FDinoAncestorsEntry, FDefaultAllocator> GetDinoAncestorsMaleField() const { return GetNativeField<TArray<FDinoAncestorsEntry, FDefaultAllocator>>(this, "APrimalDinoCharacter", "DinoAncestorsMale"); }
	//TArray<FDinoAncestorsEntry, FDefaultAllocator> GetNextBabyDinoAncestorsField() const { return GetNativeField<TArray<FDinoAncestorsEntry, FDefaultAllocator>>(this, "APrimalDinoCharacter", "NextBabyDinoAncestors"); }
	//TArray<FDinoAncestorsEntry, FDefaultAllocator> GetNextBabyDinoAncestorsMaleField() const { return GetNativeField<TArray<FDinoAncestorsEntry, FDefaultAllocator>>(this, "APrimalDinoCharacter", "NextBabyDinoAncestorsMale"); }
	...
	void GetRidingCarryingIgnoreList(TArray<AActor *, FDefaultAllocator>* IgnoreList) { NativeCall<void, TArray<AActor *, FDefaultAllocator> *>((DWORD64)this, "APrimalDinoCharacter", "GetRidingCarryingIgnoreList", IgnoreList); }
	...
	void FireMultipleProjectiles_Implementation(TArray<FVector, FDefaultAllocator>* Locations, TArray<FVector, FDefaultAllocator>* Directions, bool bScaleProjectileDamageByDinoDamage) { NativeCall<void, TArray<FVector, FDefaultAllocator> *, TArray<FVector, FDefaultAllocator> *, bool>((DWORD64)this, "APrimalDinoCharacter", "FireMultipleProjectiles_Implementation", Locations, Directions, bScaleProjectileDamageByDinoDamage); }
	...
	TArray<AShooterCharacter *, FDefaultAllocator>* GetPassengers(TArray<AShooterCharacter *, FDefaultAllocator>* result) { return NativeCall<TArray<AShooterCharacter *, FDefaultAllocator> *, TArray<AShooterCharacter *, FDefaultAllocator> *>((DWORD64)this, "APrimalDinoCharacter", "GetPassengers", result); }
	...
	void BPModifyHarvestingWeightsArray(TArray<float, FDefaultAllocator>* resourceWeightsIn, TArray<UPrimalItem *, FDefaultAllocator>* resourceItems, TArray<float, FDefaultAllocator>* resourceWeightsOut) { NativeCall<void, TArray<float, FDefaultAllocator> *, TArray<UPrimalItem *, FDefaultAllocator> *, TArray<float, FDefaultAllocator> *>((DWORD64)this, "APrimalDinoCharacter", "BPModifyHarvestingWeightsArray", resourceWeightsIn, resourceItems, resourceWeightsOut); }
...
struct AShooterWeapon : AActor
{
	...
	TArray<FName, FDefaultAllocator> GetMeleeSwingSocketsField() const { return GetNativeField<TArray<FName, FDefaultAllocator>>(this, "AShooterWeapon", "MeleeSwingSockets"); }
	void SetMeleeSwingSocketsField(TArray<FName, FDefaultAllocator> newValue) { SetNativeField(this, "AShooterWeapon", "MeleeSwingSockets", newValue); }
	...
	TArray<FVector, FDefaultAllocator> GetLastSocketPositionsField() const { return GetNativeField<TArray<FVector, FDefaultAllocator>>(this, "AShooterWeapon", "LastSocketPositions"); }
	void SetLastSocketPositionsField(TArray<FVector, FDefaultAllocator> newValue) { SetNativeField(this, "AShooterWeapon", "LastSocketPositions", newValue); }
	TArray<AWeakObjectPtr<AActor>, FDefaultAllocator> GetMeleeSwingHurtListField() const { return GetNativeField<TArray<AWeakObjectPtr<AActor>, FDefaultAllocator>>(this, "AShooterWeapon", "MeleeSwingHurtList"); }
	...
	void WeaponTraceHits(TArray<FHitResult, FDefaultAllocator>* HitResults, FVector* StartTrace, FVector* EndTrace) { NativeCall<void, TArray<FHitResult, FDefaultAllocator> *, FVector *, FVector *>((DWORD64)this, "AShooterWeapon", "WeaponTraceHits", HitResults, StartTrace, EndTrace); }
