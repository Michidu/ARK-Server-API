...
/**
 * int is used select between either 'fast' or 'thread safe' shared pointer types.
...
template< class ObjectType, int Mode = ESPMode::Fast > class TSharedRef;
template< class ObjectType, int Mode = ESPMode::Fast > class TSharedPtr;
template< class ObjectType, int Mode = ESPMode::Fast > class TWeakPtr;
template< class ObjectType, int Mode = ESPMode::Fast > class TSharedFromThis;
...
namespace SharedPointerInternals
{
	...
	template< int Mode > class FWeakReferencer;
	...
	private:
		...
		template< int OtherMode > friend class FWeakReferencer;
	...
	private:
		...
		template< int OtherMode > friend class FSharedReferencer;
