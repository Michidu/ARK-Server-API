...
{
public:
	TArray<TSubclassOf<AActor>> GetActorsClassesAllowedToSaveField() const { return GetNativeField<TArray<TSubclassOf<AActor>>>(this, "UWorld", "ActorsClassesAllowedToSave"); }
	...
	TArray<UObject *> GetExtraReferencedObjectsField() const { return GetNativeField<TArray<UObject *>>(this, "UWorld", "ExtraReferencedObjects"); }
	...
	TArray<FVector> GetViewLocationsRenderedLastFrameField() const { return GetNativeField<TArray<FVector>>(this, "UWorld", "ViewLocationsRenderedLastFrame"); }
	...
	TArray<AActor *> GetNetworkActorsField() const { return GetNativeField<TArray<AActor *>>(this, "UWorld", "NetworkActors"); }
	...
	TArray<TWeakObjectPtr<AController>> GetControllerListField() const { return GetNativeField<TArray<TWeakObjectPtr<AController>>>(this, "UWorld", "ControllerList"); }
	TArray<TWeakObjectPtr<APlayerController>> GetPlayerControllerListField() const { return GetNativeField<TArray<TWeakObjectPtr<APlayerController>>>(this, "UWorld", "PlayerControllerList"); }
	TArray<TWeakObjectPtr<APawn>> GetPawnListField() const { return GetNativeField<TArray<TWeakObjectPtr<APawn>>>(this, "UWorld", "PawnList"); }
	...
	bool PreSaveRoot(const wchar_t* Filename, TArray<FString>* AdditionalPackagesToCook) { return NativeCall<bool, const wchar_t *, TArray<FString> *>((DWORD64)this, "UWorld", "PreSaveRoot", Filename, AdditionalPackagesToCook); }
...
struct AGameMode
{
	...
	TArray<APlayerStart *> GetPlayerStartsField() const { return GetNativeField<TArray<APlayerStart *>>(this, "AGameMode", "PlayerStarts"); }
	void SetPlayerStartsField(TArray<APlayerStart *> newValue) { SetNativeField(this, "AGameMode", "PlayerStarts", newValue); }
	...
	TArray<APlayerState *> GetInactivePlayerArrayField() const { return GetNativeField<TArray<APlayerState *>>(this, "AGameMode", "InactivePlayerArray"); }
	void SetInactivePlayerArrayField(TArray<APlayerState *> newValue) { SetNativeField(this, "AGameMode", "InactivePlayerArray", newValue); }
	...
	void GetSeamlessTravelActorList(bool bToEntry, TArray<AActor *>* ActorList) { NativeCall<void, bool, TArray<AActor *> *>((DWORD64)this, "AGameMode", "GetSeamlessTravelActorList", bToEntry, ActorList); }
...
struct AShooterGameMode : AGameMode
{
	...
	TArray<APlayerStart *> GetUsedPlayerStartsField() const { return GetNativeField<TArray<APlayerStart *>>(this, "AShooterGameMode", "UsedPlayerStarts"); }
	void SetUsedPlayerStartsField(TArray<APlayerStart *> newValue) { SetNativeField(this, "AShooterGameMode", "UsedPlayerStarts", newValue); }
	...
	TArray<FTribeData> GetTribesDataField() const { return GetNativeField<TArray<FTribeData>>(this, "AShooterGameMode", "TribesData"); }
	void SetTribesDataField(TArray<FTribeData> newValue) { SetNativeField(this, "AShooterGameMode", "TribesData", newValue); }
	...
	TArray<FString> GetArkGameCodesField() const { return GetNativeField<TArray<FString>>(this, "AShooterGameMode", "ArkGameCodes"); }
	void SetArkGameCodesField(TArray<FString> newValue) { SetNativeField(this, "AShooterGameMode", "ArkGameCodes", newValue); }
	...
	TArray<UPrimalPlayerData *> GetPlayerDatasField() const { return GetNativeField<TArray<UPrimalPlayerData *>>(this, "AShooterGameMode", "PlayerDatas"); }
	void SetPlayerDatasField(TArray<UPrimalPlayerData *> newValue) { SetNativeField(this, "AShooterGameMode", "PlayerDatas", newValue); }
	...
	TArray<FPlayerDeathReason> GetPlayerDeathReasonsField() const { return GetNativeField<TArray<FPlayerDeathReason>>(this, "AShooterGameMode", "PlayerDeathReasons"); }
	void SetPlayerDeathReasonsField(TArray<FPlayerDeathReason> newValue) { SetNativeField(this, "AShooterGameMode", "PlayerDeathReasons", newValue); }
	...
	TArray<FString> GetCachedGameLogField() const { return GetNativeField<TArray<FString>>(this, "AShooterGameMode", "CachedGameLog"); }
	void SetCachedGameLogField(TArray<FString> newValue) { SetNativeField(this, "AShooterGameMode", "CachedGameLog", newValue); }
	...
	TArray<int> GetSupportedSpawnRegionsField() const { return GetNativeField<TArray<int>>(this, "AShooterGameMode", "SupportedSpawnRegions"); }
	void SetSupportedSpawnRegionsField(TArray<int> newValue) { SetNativeField(this, "AShooterGameMode", "SupportedSpawnRegions", newValue); }
	...
	TArray<FString>* GetWhiteListedMap(TArray<FString>* result) { return NativeCall<TArray<FString> *, TArray<FString> *>((DWORD64)this, "AShooterGameMode", "GetWhiteListedMap", result); }
	...
	void GetActorSaveGameTypes(TArray<TSubclassOf<AActor>>* saveGameTypes) { NativeCall<void, TArray<TSubclassOf<AActor>> *>((DWORD64)this, "AShooterGameMode", "GetActorSaveGameTypes", saveGameTypes); }
	...
	void SendServerNotification(FString* MessageText, FLinearColor MessageColor, float DisplayScale, float DisplayTime, DWORD64 MessageIcon, DWORD64 SoundToPlay, int ReceiverTeamId, int ReceiverPlayerID, bool bDoBillboard) { NativeCall<void, FString *, FLinearColor, float, float, DWORD64, DWORD64, int, int, bool>((DWORD64)this, "AShooterGameMode", "SendServerNotification", MessageText, MessageColor, DisplayScale, DisplayTime, MessageIcon, SoundToPlay, ReceiverTeamId, ReceiverPlayerID, bDoBillboard); }
	...
	void UpdateTribeAllianceData(FTribeAlliance* TribeAllianceData, TArray<unsigned int>* OldMembersArray, bool bIsAdd) { NativeCall<void, FTribeAlliance *, TArray<unsigned int> *, bool>((DWORD64)this, "AShooterGameMode", "UpdateTribeAllianceData", TribeAllianceData, OldMembersArray, bIsAdd); }
