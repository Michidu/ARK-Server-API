...
namespace ArkApi
{
	...
	void Offsets::Init(std::unordered_map<std::string, intptr_t>&& offsets_dump, std::unordered_map<std::string, BitField>&& bitfields_dump, const bool PluginReloadEnabled, const int PluginReloadSeconds)
	{
